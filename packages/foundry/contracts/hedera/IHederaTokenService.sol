...
interface IHederaTokenService {
    ...
    /// @param from The account address of the token owner.
    /// @param to The account address receiving the tokens.
    ...
    /// Returns the amount `spender` can still withdraw from `owner`.
    /// Only applicable to fungible tokens.
    /// @param token The Hedera token address to check allowance for.
